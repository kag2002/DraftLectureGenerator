...
def build_generator_user_prompt_compact(*, course_name: str, clo_context: str, chapter_context: str, rag_context: str, count: int) -> str:
    """
...
def build_correction_prompt(*, question_text: str, options_json: str, target_answer: str, solver_answer: str, solver_reasoning: str = "") -> str:
    """
